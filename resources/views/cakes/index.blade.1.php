                                            ...
                                            @forelse($cakes as $cake)
                                                <tr>
                                                    ...
                                                    <td class="text-center border-2 p-2">
                                                        <button type="button" data-id="{{$cake->id}}" class="m-2 p-2 whitespace-nowrap text-white bg-gray-400 focus:outline-none hover:bg-gray-600 rounded hidden unlock">解除</button>
